IOBASE   = $FFE1	; register to read/write data from ACIA
IOSTATUS = $FFE0	; location of status register
IOCMD    = $FFE0	; location of command register
IOCMD_INIT = $0B;	; init value for ACIA
IOSTATUS_RXFULL = $01;
IOSTATUS_TXEMPTY = $02;
...
.proc io_init
    ...
    sta $FFE3          ; program the ctl register
	rts
.endproc
