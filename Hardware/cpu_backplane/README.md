...
This computer can run absolutely stand alone when connected via the serial port. It can also accomodate 2 more expansion cards compared to the original backplane.
