...
![address decoding and clock](Hardware/backplane/address_clk.png)
...
The expansion slots are common 2x25 "Dupont" sockets on 2.54mm (100mil) centers as are very easy to obtain.
...
![address decoding and clock](Hardware/backplane/io.png)
...
![address decoding and clock](Hardware/backplane/power.png)
